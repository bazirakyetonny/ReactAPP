...
function BugIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 21 21">
      <path id="analyze" d="M8.786.02a9.494,9.494,0,0,0-5.194,2A12.252,12.252,0,0,0,1.912,3.739a9.426,9.426,0,0,0-.989,9.768,9.243,9.243,0,0,0,1.85,2.582,8.991,8.991,0,0,0,3.369,2.18,9.4,9.4,0,0,0,8.934-1.292l.415-.313,2.135,2.128c2.3,2.294,2.217,2.223,2.6,2.219A.8.8,0,0,0,21,20.234c0-.381.074-.3-2.218-2.6L16.654,15.5l.312-.415A9.442,9.442,0,0,0,16.94,3.739,12.292,12.292,0,0,0,15.26,2.022,9.488,9.488,0,0,0,10.689.085,16.037,16.037,0,0,0,8.786.02M10.8,1.738a7.507,7.507,0,0,1,1.3.35,7.806,7.806,0,0,1,5.02,5.973,9.789,9.789,0,0,1,.048,2.389,7.775,7.775,0,0,1-4.3,5.993,7.3,7.3,0,0,1-3.432.791,7.354,7.354,0,0,1-3.361-.755,7.824,7.824,0,0,1-4.178-5.023,5.959,5.959,0,0,1-.232-2.025,6,6,0,0,1,.217-1.976A7.841,7.841,0,0,1,7.847,1.781a6.249,6.249,0,0,1,1.7-.129,6.4,6.4,0,0,1,1.245.086m2.615,4.8c-.079.033-.743.672-1.787,1.715L9.959,9.911l-.845-.842a12.438,12.438,0,0,0-.97-.905.892.892,0,0,0-.694.013c-.084.044-.74.676-1.6,1.546C4.307,11.273,4.3,11.278,4.3,11.592a.862.862,0,0,0,.48.725.938.938,0,0,0,.651.012,12.252,12.252,0,0,0,1.253-1.174l1.12-1.119.818.821c.867.872,1.027.992,1.316.993.361,0,.279.071,2.445-2.093,1.154-1.152,2.044-2.07,2.077-2.14a.817.817,0,0,0-.422-1.087.984.984,0,0,0-.632,0" transform="translate(0.001 -0.011)" fill="#7c8791" fill-rule="evenodd"></path>
    </svg>
  );
}
...
function FrameIcon() {
  return (
    <svg id="copySelectButton" xmlns="http://www.w3.org/2000/svg" width="31" height="24" viewBox="0 0 21 23">
...
function RedoIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="21" viewBox="0 0 21 21">
      <path id="Group_4630-converted" data-name="Group 4630-converted" d="M20.692.033a1.038,1.038,0,0,1,.636.6c.031.1.042.909.042,2.993V6.481l-.092.185a.9.9,0,0,1-.468.443,15.23,15.23,0,0,1-3.07.056c-3.276-.011-3.009.012-3.293-.281a.936.936,0,0,1,.3-1.484,6.933,6.933,0,0,1,1.779-.083L18.163,5.3l-.619-.608a8.83,8.83,0,0,0-2.617-1.877,8.95,8.95,0,0,0-4.087-.933,8.081,8.081,0,0,0-3.731.845,8.763,8.763,0,0,0-3.575,3.19A8.994,8.994,0,0,0,2.4,8.69a9.35,9.35,0,0,0,0,3.64,8.7,8.7,0,0,0,3.667,5.377,10.6,10.6,0,0,0,1.852.939,8.735,8.735,0,0,0,4.9.287A8.63,8.63,0,0,0,16.087,17.4a11.708,11.708,0,0,0,1.664-1.664,8.6,8.6,0,0,0,1.185-2.211.844.844,0,0,1,.673-.283.877.877,0,0,1,.836.507,1.006,1.006,0,0,1,.092.578c0,1.02-1.06,2.42-2.251,3.606a9.815,9.815,0,0,1-2.751,1.98,9.98,9.98,0,0,1-2.641.907A8.655,8.655,0,0,1,10.8,21a8.833,8.833,0,0,1-2.39-.269,10.52,10.52,0,0,1-7.8-7.847,8.76,8.76,0,0,1-.249-2.373A7.879,7.879,0,0,1,.45,9.03a10.247,10.247,0,0,1,.985-3.159A10.488,10.488,0,0,1,8.842.2,8.922,8.922,0,0,1,10.894.021a10.8,10.8,0,0,1,4.791,1.086,10.807,10.807,0,0,1,3.193,2.278l.632.622.01-1.673c.011-1.641.012-1.677.088-1.819A.985.985,0,0,1,20.692.033" transform="translate(-0.369 -0.001)" fill="#7c8791" fill-rule="evenodd"></path>
    </svg>
  );
}

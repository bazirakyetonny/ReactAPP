            ...
            {appVersions.map((v) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    {canCreateTemplate
                      ? v.IsPublishedTemplate ? <PublishedIcon /> : <UnpublishedIcon />
                      : <LocationPinIcon />}
